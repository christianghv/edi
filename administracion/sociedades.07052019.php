									...
									<div id="divCabecera">
										<form name="FormIngresarSociedad" id="FormIngresarSociedad" method="post" action="" onSubmit="return false;">
											...
											<div class="row">
												...
												<div class="col-lg-4" style="width:270px" >
													<div class="form-group">
														<label>Lineas EE: </label>
														<br />
														<input type="number" class="form-control" placeholder="Lineas" name="Sociedad_lineas" id="Sociedad_lineas" value="" size="25" min="1" max="300" style="width:230px;"  required="required" title="Ingrese Tolerancia"/>        
													</div>
												</div>
											</div>
