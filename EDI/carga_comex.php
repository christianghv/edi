...
if (!isset($_SESSION["id_proveedor"]) && !isset($_SESSION["email"])){
	...
	$AccesoPermiso=VerificarPermiso(18);
...
<head>  
    <title>CARGA COMEX</title>
   <?php include("includes.php"); ?>
    <script src="js/carga_comex.js"></script>
	...
	<div id="page_header_principal">
        ...
        <!--<div id="page-wrapper">-->
			...
			<div class="row">
				...
				<div class="col-lg-4">
					<input type="hidden" id="accion_subida" name="accion_subida" value="SUBIR_CARGA_MANUAL_COMEX"/>
