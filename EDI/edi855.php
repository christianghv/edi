...
<head>  
    ...
    <script src="js/edi855.js"></script>
	
	<script>
		window.onbeforeunload = function(e) {
		  return "Esta a punto de abandonar EDI855. Para regresar presione botón 'Volver'";
		};
	</script>
	...
	#tabla_oc_principal thead {display: none;}
	</style>
</head>
...
<?
				...
				$tmp_soc->show();
				$tmp_fac = new templates("templates/f_oc.html");
				$tmp_fac->show();
...
<div style="margin-left:25px; margin-top:-5px;" class="row" id="Divbtn_volverHome">
		<div align="left">
    		<button name="btn_incio" id="btn_incio" class="btn btn-info" type="button" title="Volver a Menú Principal"> 
