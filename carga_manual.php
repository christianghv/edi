...
<div id="pagina_principal" style="display:block;"><!--DIV PAGINA PRINCIPAL-->
	<div id="page_header_principal">
        ...
        <?
			...
			'reporte' => "CARGAR ARCHIVO CON EDIs",
        ...
        <!--<div id="page-wrapper">-->
			...
			<form action="ajax/subir_archivo.php" method="post" id="formSubirExcel" name="formSubirExcel" enctype="multipart/form-data">
<input type="submit">
