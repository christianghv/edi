            ...
            <div class="main-container">
                <div class="main clearfix">
                    ...
                    <article class="interno">
                        <header>
                            <img src="img/interior-menu.png" alt="proveedores">
                            <h1>Internos</h1>
                        </header>
                    ...
                    <article class="contenido scroll">
                        <div class="oc">
                            ...
                            <h1><a href="proveedores/descargarOC850.php" id="descargar_oc">DESCARGAR<br /><span>OC</span></a></h1>
                        </div>
                        <div class="division"></div>
                        <div class="factura">
                            <img src="img/factura.png" alt="FACTURA"/>
                            <h1><a href="proveedores/facturas.php" id="cargar_factura">CARGAR<br /><span>FACTURA</span></a></h1>
                        </div>
                    </article>
                </div> <!-- #main -->
            </div> <!-- #main-container -->
